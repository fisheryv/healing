...
const translations = {
  ...
  signup: {
    ...
    codePlaceholder: { zh: '6位验证码', en: '6-digit code' },
    codeRequired: { zh: '请输入验证码。', en: 'Verification code is required.' },
    codeIncorrect: { zh: '验证码不正确。', en: 'Incorrect verification code.' },
    demoCode: { zh: '演示验证码：', en: 'Demo code: ' },
    send: { zh: '发送', en: 'Send' },
    ...
    password: { zh: '密码', en: 'Password' },
    passwordPlaceholder: { zh: '至少6个字符', en: 'At least 6 characters' },
    passwordRequired: { zh: '请输入密码。', en: 'Password is required.' },
    passwordShort: { zh: '密码至少需要6个字符。', en: 'Password must be at least 6 characters.' },
    showPassword: { zh: '显示密码', en: 'Show password' },
    hidePassword: { zh: '隐藏密码', en: 'Hide password' },
  ...
  forgot: {
    ...
    login: { zh: '登录', en: 'Login' },
    successMsg: { zh: '密码已成功重置，你现在可以使用新密码登录了。', en: 'Your password has been reset successfully. You can now log in with your new password.' },
