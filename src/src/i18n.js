...
const translations = {
  ...
  focusSession: {
    ...
    abandon: { zh: '退出', en: 'Quit' },
    abandonBtn: { zh: '退出', en: 'QUIT' },
    ...
    min: { zh: '分', en: 'min' },
    sec: { zh: '秒', en: 'sec' },
    abandonTitle: { zh: '退出专注', en: 'Quit Focus Session' },
    abandonConfirm: { zh: '确定要退出这次专注吗？', en: 'Are you sure you want to quit this focus session?' },
    continueFocus: { zh: '继续专注', en: 'Continue Focus' },
    bestWithHeadphones: { zh: '建议佩戴耳机', en: 'Best with Headphones' },
    save: { zh: '保存', en: 'Save' },
    inkFlow: { zh: '墨韵', en: 'Ink Flow' },
    fragmentDistracted: { zh: '残卷 · 分心中断', en: 'Fragment · Distracted' },
    fragmentAbandoned: { zh: '残卷 · 主动退出', en: 'Fragment · Quit' },
    atMin: { zh: '分钟', en: 'min' },
  },
